...
import { generateQRKey, generateQRCode, checkQRStatus, extractMusicUCookie, getLoginStatus } from '@/lib/netease';
...
export default function NeteaseQRLoginModal({ isOpen, onClose, userId, onSuccess }: NeteaseQRLoginModalProps) {
